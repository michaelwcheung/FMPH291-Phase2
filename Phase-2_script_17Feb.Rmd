...
model_1a <- glmer(any_modern ~ more_daughters + w_edu_yrs + m_edu_yrs + w_age + m_age + 
...
```{r Step-2, echo=TRUE}
model_1b <- glmer(both_want ~ more_daughters + (1 | v001), data = df_couples_2, family = "poisson")
...
model_2a <- glmer(any_modern ~ more_daughters + w_edu_yrs + m_edu_yrs + w_age + m_age + 
